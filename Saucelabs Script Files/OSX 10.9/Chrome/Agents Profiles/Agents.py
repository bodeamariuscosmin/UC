...
class Selenium2OnSauce(unittest.TestCase):
    ...
    def setUp(self):
        ...
        desired_capabilities['name'] = 'Agents'
        ...
        self.base_url = "https://staging.urbancompass.com/agents/profiles"
    
    def test_ui(self):
        driver = self.driver
        driver.get(self.base_url + "/")

        inputElement = driver.find_element_by_xpath(".//*[@id='container']/div/div[2]/div[2]")
