...
class LogInSales(unittest.TestCase):
    ...
    def test_log_in_sales(self):
        ...
        driver.find_element_by_xpath(".//*[@id='please-sign-in']/div[2]/form/fieldset[2]/input").send_keys("parola")
        driver.find_element_by_xpath(".//*[@id='please-sign-in']/div[2]/form/input").click()
        time.sleep(2)
